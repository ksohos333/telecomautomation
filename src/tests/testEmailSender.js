const { sendEmailResponse } = require('../services/emailSender');
...
async function testEmailSender() {
  try {
    ...
    const result = await sendEmailResponse(
      TEST_EMAIL,
      'Test Email from Telecom Automation',
      'This is a test email from the Telecom Automation system.\n\nIf you received this, the email integration is working correctly!',
      '<h1>Test Email</h1><p>This is a test email from the Telecom Automation system.</p><p>If you received this, the email integration is working correctly!</p>'
    );
